...
## Your job
Build `src/services/gemini.rs` — the function Backend Person 2 calls to get plain-English fraud explanations.
...
Gemini free tier is 15 RPM. Add a simple guard so demo doesn't hit the limit:
...
pub async fn explain_fraud(...) -> Result<String, ...> {
